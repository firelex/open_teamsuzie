...
function Wordmark({ title }: { title: string }) {
  return (
    <div className="flex items-center gap-2.5">
      <div
        aria-hidden="true"
        className="grid size-6 place-items-center rounded-md border border-primary/40 bg-primary/10 font-mono text-[11px] font-semibold text-primary"
      >
        {'{}'}
      </div>
      <div className="flex flex-col leading-tight">
        ...
        <span className="suzie-eyebrow mt-0.5">SuzieCode</span>
      </div>
    </div>
  );
}
